...
export const TOOLS: Tool[] = [
  ...
  { id: "unit-converter", title: "Universal Unit Converter", description: "Convert length, mass, temperature, area, and speed units.", longDescription: "Convert metric and imperial units across length, mass, volume, and temperature.", category: "conversion", icon: "Repeat", popular: true, recentlyAdded: true, cta: "Convert Units" },
  ...
  { id: "json-formatter", title: "JSON Formatter & Prettier", description: "Format, validate, minifying, and clean JSON payloads.", longDescription: "Validate JSON structure, format indents, and minify raw JSON payloads.", category: "developer", icon: "Code", popular: true, recentlyAdded: true, cta: "Format JSON" },
