...
export const TOOLS: Tool[] = [
  ...
  { id: "markdown-viewer", title: "Open MD File & Markdown Viewer", description: "Open and view MD files online with live split-screen Markdown preview, GitHub tables, checklists, and 1-click export to PDF, Word, and HTML.", longDescription: "A fast, 100% private in-browser Markdown file viewer, editor, and converter. Drag-and-drop or open .md files, paste Markdown text directly, inspect real-time word and character statistics, and render GitHub Flavored Markdown (GFM) tables, task checklists, and code fences. Export your rendered Markdown directly to PDF, Microsoft Word, or HTML without uploading data to any server.", category: "developer", icon: "FileText", popular: true, recentlyAdded: true, cta: "Open MD File Online" },
