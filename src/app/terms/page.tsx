          ...
          <main className="max-w-3xl flex-1 pb-20">
            ...
            <section id="services" className="scroll-mt-32">
              ...
              <p className="text-base md:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed">
                Yutiliti provides a suite of advanced developer and media utilities provided "as is" and "as available". We do not guarantee uninterrupted, secure, or error-free tools. 
            ...
            <section id="responsibilities" className="scroll-mt-32">
              ...
              <p className="text-base md:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed mb-6">
                You are solely responsible for the files, images, and raw data you process using Yutiliti. 
                While Yutiliti guarantees data privacy by avoiding external servers, you must ensure you have the legal right and copyright permissions to modify, share, or reproduce the documents and images processed through our toolkit.
              </p>
              <p className="text-base md:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed">
            ...
            <section id="proprietary" className="scroll-mt-32">
              ...
              <p className="text-base md:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed">
                The original interface, aesthetic layout, structural design, and specific combination of local technologies that formulate Yutiliti are our exclusive property. 
                You may not blindly copy, scrape, or reverse-engineer the visual branding of Yutiliti without express written authorization.
              </p>
            </section>
            ...
            <section id="warranties" className="scroll-mt-32">
              ...
              <p className="text-base md:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed">
                Yutiliti is utilized entirely at your own risk. The toolsets are provided without any warranties, express or implied. 
            ...
            <section id="liability" className="scroll-mt-32">
              ...
              <p className="text-base md:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed">
                In no absolute event shall Yutiliti, nor its developers, be held liable for any indirect, incidental, consequential, or punitive damages arising out of your access to our utility suite. 
