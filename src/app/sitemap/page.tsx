...
export const metadata: Metadata = {
  ...
  description:
    "Complete directory of all 82+ free client-side browser tools, financial calculators, converters, category hubs, and technical guides on Yuitility.",
  alternates: {
  ...
  openGraph: {
    title: "HTML Sitemap: All Tools, Categories & Guides - Yuitility",
    description:
      "Explore the complete index of 82+ private browser utilities, calculators, and guides across Yuitility.",
